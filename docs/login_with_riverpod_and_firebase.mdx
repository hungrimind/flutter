...
Using our organized Riverpod state management system we will add third party sign in. Third party sign in with Firebase follow a very similar flow. So even though in this case we are using Apple Sign In you can still follow a similar process to add other third party sign in methods
